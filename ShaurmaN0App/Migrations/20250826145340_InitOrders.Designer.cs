...
namespace ShaurmaN0App.Migrations
{
    ...
    [Migration("20250826145340_InitOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShaurmaN0App.Models.Menus", b =>
                {
                    b.Property<Guid>("Id")
                        ...
                        .HasDefaultValue(new Guid("36aabd50-6455-4d47-9827-b65e60e29d6f"));
            ...
            modelBuilder.Entity("ShaurmaN0App.Models.MenusCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("83ce475a-ee39-47e8-a7bd-074e224fe17d"));
            ...
            modelBuilder.Entity("ShaurmaN0App.Models.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShaurmaN0App.Models.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShaurmaN0App.Models.OrderItem", b =>
                {
                    b.HasOne("ShaurmaN0App.Models.Menus", "Menus")
                        .WithMany()
                        .HasForeignKey("MenusId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ShaurmaN0App.Models.Order", null)
                        .WithMany("OrderItems")
